#!/usr/bin/env python3
"""
PRIME-EV V6.1 reviewer-ready end-to-end experiment script
=====================================================
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="PRIME-EV V6 reviewer-ready experiment script.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def main() -> None:
    ...
    upload_files = [
        ...
        "conv_feature_permutation_sensitivity.csv",
        "fairness_and_accessibility.csv",
        ...
        "label_weight_sensitivity.csv",
        "regional_transfer_results.csv",
        "v5_compact_reviewer_table.tex",
    ]
    (output_dir / "V6_UPLOAD_THESE_FILES.txt").write_text("\n".join(upload_files), encoding="utf-8")

    print("\nPRIME-EV V6 reviewer-ready run completed")
    ...
    print("Upload the files listed in V6_UPLOAD_THESE_FILES.txt for manuscript table updates.")
