...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--patience", type=int, default=20, help="Early-stopping patience measured in epochs")
    parser.add_argument("--validation-metric", choices=["ndcg_full", "ndcg_top_fraction"], default="ndcg_top_fraction", help="Metric used for early stopping and checkpoint selection")
    parser.add_argument("--lambda-risk", type=float, default=1.0, help="Weight for Gaussian risk loss")
    parser.add_argument("--lambda-demand", type=float, default=0.5, help="Weight for auxiliary demand loss")
    parser.add_argument("--lambda-rank", type=float, default=3.0, help="Weight for pairwise ranking loss")
